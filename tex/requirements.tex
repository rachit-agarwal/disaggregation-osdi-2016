...
Our measurement, as shown in Figure~\ref{fig:memband}, indicates that applications that make greater use of memory bandwidth will experience higher performance degradation in \dis. Therefore, one might instrument other applications' memory bandwidth utilization for a preview of their performance in a disaggregated environment. 
}
