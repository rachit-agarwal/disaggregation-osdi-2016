...
\rc{
    \paragraphb{Intuition for results} Figure~\ref{fig:memband} compares memory bandwidth with perf degradation  which explains our results. More memory bandwidth = more degradation
}
