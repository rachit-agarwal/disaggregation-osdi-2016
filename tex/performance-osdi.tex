...
\paragraphb{Traffic Generation}
We simulate a disaggregated datacenter under two settings in a datacenter with 144 nodes.
...
\rc{
\paragraphb{Measuring page fault latency}
...
Overall, our measurement code introduces a very small (~5) number of bitwise
